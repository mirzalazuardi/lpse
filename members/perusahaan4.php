...
<html>
<head>
<title>Form Perusahaan - Pemilik Perusahaan</title>
      ...
      <div class="row" ng-controller="myCtrl">
        ...
        <br><br>
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li class="active"><a href="../pemilik/">Pemilik Perusahaan</a></li>
              <li><a href="../ijin/">Jenis Ijin Usaha</a></li>
              <li><a href="../../keluar">Keluar</a></li>
            </ul>
            <br>
          <form class="form-horizontal" role="form" name="myForm" method="POST" action="perusahaan4_proceed.php">
