...
CREATE TABLE `tbl_akta_perusahaan` (
  ...
  PRIMARY KEY (`id`),
  KEY `akta_utama_FK` (`id_utama`),
  CONSTRAINT `akta_utama_FK` FOREIGN KEY (`id_utama`) REFERENCES `tbl_utama_perusahaan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tbl_ijin_perusahaan` (
  ...
  PRIMARY KEY (`id`),
  KEY `ijin_utama_FK` (`id_utama`),
  CONSTRAINT `ijin_utama_FK` FOREIGN KEY (`id_utama`) REFERENCES `tbl_utama_perusahaan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_pemilik_perusahaan` (
  ...
  PRIMARY KEY (`id`),
  KEY `pemilik_utama_FK` (`id_utama`),
  CONSTRAINT `pemilik_utama_FK` FOREIGN KEY (`id_utama`) REFERENCES `tbl_utama_perusahaan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_pengurus_perusahaan` (
  ...
  PRIMARY KEY (`id`),
  KEY `pengurus_utama_FK` (`id_utama`),
  CONSTRAINT `pengurus_utama_FK` FOREIGN KEY (`id_utama`) REFERENCES `tbl_utama_perusahaan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_utama_perusahaan` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_utama_perusahaan_tbl_users_FK` (`id_users`),
  CONSTRAINT `tbl_utama_perusahaan_tbl_users_FK` FOREIGN KEY (`id_users`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
